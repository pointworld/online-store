        ...
        <div class="item-info" id="item-info">
          <dl class="loaded">
            <dt class="product_name">
              ...
              <p class="desc"><span class="gray">{{proDetail.brief}}</span></p>
            </dt>
            <dd class="property">
              <ul>
                <li v-if="proDetail.freight_free">此商品为免运费商品，计算配送金额时将不计入配送费用 </li>
                <li>
                ...
                <li>
                  ...
                  class="red">{{proDetail.sold_nums}}</em>件</span></li>
              </ul>
            </dd>
              ...
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div class="skunum" id="skunum">
                    ...
                    <cite class="storage">(<font id="shows_number">{{proDetail.stock_nums}}件</font>)</cite>
